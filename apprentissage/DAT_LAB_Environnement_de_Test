...
![alt text](Images/Capture_Diagramme_projet.png)

7. **Vérification des images (hashs/ signatures)**

Hash debian 13

![alt text](Images/Capture_hash_debian_officiel.png)


![alt text](Images/Capture_vérification_hash_debian.png)

Hash Windows server 2022

![alt text](Images/Capture_hash_iso_winserver.png)
