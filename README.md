...
- [1️⃣ Script-Python AIS](https://github.com/Y4nnSec/AIS/blob/main/apprentissage/test.py) et (https://github.com/Y4nnSec/AIS/blob/main/apprentissage/test6.py) – automatisation de tâches liées à l'administration sécurisée.  
